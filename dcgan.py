...
Original file is located at
    https://colab.research.google.com/drive/11qZ--h7XhAE3Omj-YVFDQMCD5plaC1fi
"""
...
for epoch in tqdm(range(18000)):
   for i, data in enumerate(trainloader, 0):
        ...
        print('[%d/%d][%d/%d] Loss_D: %.4f Loss_G: %.4f D(x): %.4f D(G(z)): %.4f / %.4f' % (epoch, 1000, i, len(trainloader),
